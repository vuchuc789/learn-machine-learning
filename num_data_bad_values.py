...
def main():
    ...
    plot_the_dataset("calories", "test_score", number_of_points_to_plot=200)
    ...
    for week in range(0, 4):
        for day in range(0, 7):
            for subject in range(0, 50):
                ...
                if day == 4:  # Thursday
                    running_total_of_thursday_calories += training_df["calories"][
                        position
                    ]
    ...
    print(
        "The mean of calories on days other than Thursday is %.0f"
        % (mean_of_non_thursday_calories)
    )
